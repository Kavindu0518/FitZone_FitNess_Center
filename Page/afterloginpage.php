...
<html lang="en">
  ...
  <!-- <nav>
      ...
      <ul class="nav__links">
        <li class="link"><a href="afterloginpage.php">Home</a></li>
        <li class="link"><a href="service.php">Service</a></li>
        <li class="link"><a href="program.php">Classes</a></li>
        <li class="link"><a href="gallery.php">Gallery</a></li>
        <li class="link"><a href="contact.php">Contact</a></li>
        <li class="link"><a href="about.php">About</a></li>
        <li class="link"><a href="index.php">Log out</a></li>
      </ul>
...
?>
    ...
    <section class="section__container explore__container">
      ...
      <div class="explore__grid">
        ...
        <div class="explore__card">
          ...
          <a href="createaccount.php">Join Now <i class="ri-arrow-right-line"></i></a>
        </div>
        <div class="explore__card">
    ...
    <section class="section__container class__container">
      <div class="class__image">
        <span class="bg__blur"></span>
        <img src="../assets/index3.jfif" alt="class" class="class__img-1" />
        ...
        <div class="review__content">
          ...
          <div class="review__footer">
            <div class="review__member">
              <img src="../assets/Kavindu.jpeg" alt="member" />
              <div class="review__member__details">
                <h4>Kavindu Gamage</h4>
    ...
    <footer class="section__container footer__container">
      ...
      <div class="footer__col">
        <div class="footer__logo"><img src="../assets/logo23.png" alt="logo" /></div>
        <p>
